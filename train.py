...
if __name__ == '__main__':
    ...
    data_loader = get_dataloader(opt.image_dir, opt.mask_dir, opt.base_mask, facial_fea_names, facial_fea_attr_names,
                                 facial_fea_attr_len, facial_attr_dataset, opt.p_irregular_miss, opt.max_num_miss,
                                 opt.image_size, opt.dataset_name, opt.dilate_iter, opt.is_train,
